...
def plot_figs(box_vals,outdir_tmp,hm,compr_figname,peak_file):
...
#         print(hm,compr_pos,s,p)
    ...
    plt.savefig(outdir_tmp+os.sep+'{}_{}_on_{}.png'.format(hm,compr_figname,peak_file),bbox_inches='tight',pad_inches=0.1,dpi=600)
    plt.show()
    plt.close()
...
outdir = 'f3_utx_binding_DCI_figs_w_k27ac'
    ...
    for subdir in subdirs[:]:
        ...
        for dci_file_basename in name_match_df.index[:]:
            ...
            if os.path.isfile(dci_file):
                ...
                bart3d_dci_file='../f0_run_bart3d_new/{}/{}_differential_score.bed'.format(subdir,dci_file_basename)
                ...
                plot_figs(box_vals,outdir_tmp,hm,compr_figname,peak_file)
