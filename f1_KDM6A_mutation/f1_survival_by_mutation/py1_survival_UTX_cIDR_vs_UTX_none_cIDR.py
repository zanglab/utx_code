...
def survival_for_two(df,treat,legends,figname):
    ...
    lg = ax.legend(handles[1::2], legends,loc='lower left',fontsize=14,frameon=False,borderaxespad=.1,handletextpad=.2,labelspacing=.2,handlelength=1.1)
    if pvalue<0.05:
...
outdir = 'f1_figs_UTX_cIDR_vs_UTX_none_cIDR'
...
figname = outdir+os.sep+'survival_UTX_cIDR_vs_UTX_none_cIDR.png'
