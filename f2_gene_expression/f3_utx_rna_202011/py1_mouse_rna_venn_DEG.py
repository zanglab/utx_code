...
def main(infile):
    ...
    indir='{}/f0_data_process/rna_seq/data_202011RNASEQ/star_rsem_process_mouse/f6_deg/f2_deg'.format(project_dir)
    outdir = 'f1_mouse_rna_venn_DEG'
    os.makedirs(outdir,exist_ok=True)
    
    for deg_type in ['up','dn']:
        for compr_type in ['UTX-DEL3-3','UTX-DEL3-72']:
            deg_list_t = '{}/treated_{}_vs_ctrl_UTX-WT.deseq2.csv_adjp0.05_logfc0.32_{}genes.txt'.format(indir,compr_type,deg_type)
            deg_list_c = '{}/treated_UTX-KO_vs_ctrl_UTX-WT.deseq2.csv_adjp0.05_logfc0.32_{}genes.txt'.format(indir,deg_type)
            ...
            venn2_plot(set(deg_t),set(deg_c),compr_type,'UTX-KO',figname,compr_type,deg_type)
