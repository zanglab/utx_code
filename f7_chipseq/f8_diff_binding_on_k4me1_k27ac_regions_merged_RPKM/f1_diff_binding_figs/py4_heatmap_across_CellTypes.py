...
#     if heatmap_pos==0:
#         ax.set_ylabel('{} binding sites\n (#{})\n'.format(peak_file,df.shape[0]),va='baseline',fontsize=10)
...
factors = ['H3K27me3','H3K4me1','H3K27ac']
...
for peak_file in peak_files[:]:
    ...
    for factor in factors[:]:
        ...
        # fig = plt.figure(figsize = (0.9*factor_cellTypes_num,1.3))
        ...
        plt.title('{} (n = {})'.format(factor,master_df.shape[0]),fontsize=11)
