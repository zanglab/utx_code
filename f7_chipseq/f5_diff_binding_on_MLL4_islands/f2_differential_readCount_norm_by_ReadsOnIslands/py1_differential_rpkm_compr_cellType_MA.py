...
def return_chipseq_rpkm_csv(celltype,factor,genomic_region,norm_col):
    ...
    file_dir='{}/f7_chipseq/f5_diff_binding_on_MLL4_islands/data_RPKM/rpkm_csv'.format(project_dir)
    csv_file='{}/{}_{}_on_MLL4_islands{}.csv'.format(file_dir,celltype,factor,genomic_region)
