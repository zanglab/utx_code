...
factors = ['UTX','H3K4me1','H3K4me2','H3K4me2APR','H3K27ac','H3K27me3','H3K4me3','MLL4']
...
outdir = 'f4_heatmap_across_CellTypes_by_UTX_qvalue'
...
for peak_file in peak_files[:]:
    ...
    master_df = master_df.loc[ranked_index].dropna()
    for factor in factors[3:5]:
