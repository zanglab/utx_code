...
promoter_file='/Volumes/zanglab/zw5j/data/geneID_annotation/hg38/hg38_4k_promoter_geneID.bed'
...
# peak_file_dir='{}/f7_chipseq/f8_diff_binding_on_k4me1_k27ac_regions/data_hm_binding'.format(project_dir)
...
''')
        ...
        #########################
            ...
            slurmout.write('python get_RP_from_readcount.py \\\n-i {} \\\n-t {} \\\n-s hg38 -f bam -o {}/{}_on_{}.csv\n\n'.format(promoter_file,bamfile,outdir,basename,prename))
