...
antibody_pairs = [['H3K27ac','H3K4me1'],['H3K27ac','H3K4me2'],\
                  ...
                  ['UTX','H3K27ac'],['UTX','H3K4me1'],['UTX','H3K4me2'],['UTX','H3K4me3'],['UTX','MLL4'],\
                  ['H3K4me2','H3K4me1'],['H3K4me2','H3K4me3']]

antibody_pairs = [['MLL4','H3K4me1']]
norm_cols = ['total_in_islads','total']

indir='f1_differential_binding_MA'
outdir='f3_differential_MLL4_cor_K4me1'
    ...
    for compr_pair in compr_pairs[:]:
        for norm_col in norm_cols:
            for genomic_region in genomic_regions:
                ...
                plt.savefig(outdir+os.sep+'{}_vs_{}_compr_{}_{}_{}.pdf'.format(antibody_pair[0],antibody_pair[1],compr_pair,norm_col,genomic_region),bbox_inches='tight',pad_inches=0.1,dpi=600,transparent=True)
                plt.show()
                plt.close()
