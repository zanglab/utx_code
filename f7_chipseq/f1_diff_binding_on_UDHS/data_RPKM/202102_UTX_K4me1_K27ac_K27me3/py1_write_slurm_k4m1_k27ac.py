...
slurm_dir = 'run_get_RPKM_slurms_k4m1_k27ac'
outdir='rpkm_csv'
os.makedirs(slurm_dir,exist_ok=True)
os.makedirs(outdir,exist_ok=True)

project_dir='/nv/vol190/zanglab/zw5j/since2019_projects/UTX_HaoJiang'
bam_dir='{}/f0_data_process/chip_seq/final_chipseq/202102_H3K27ac_H3K4me1_trim/process_qc_out/'.format(project_dir)
...
celltypes = ['Vector','WT','DEL','EIF','MT2']
chip_markers= ['H3K4me1','H3K27ac']
