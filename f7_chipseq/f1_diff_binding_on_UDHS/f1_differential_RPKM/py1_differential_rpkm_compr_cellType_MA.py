...
def return_differential_score(df,treatment,control,antibody,genomic_region,outdir):
...
for antibody in antibodys[:]:
    for genomic_region in genomic_regions[:]:
        ...
        df = return_differential_score(df,'WT','Vector',antibody,genomic_region,outdir)
        df = return_differential_score(df,'DEL','WT',antibody,genomic_region,outdir)
        df = return_differential_score(df,'EIF','DEL',antibody,genomic_region,outdir)
