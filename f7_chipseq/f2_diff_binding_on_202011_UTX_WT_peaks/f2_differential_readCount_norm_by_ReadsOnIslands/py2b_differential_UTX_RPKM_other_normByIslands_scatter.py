...
def return_differential_values(indir,antibody,compr_pair):
    if antibody=='UTX':
        ...
        par_dir='../f1_differential_RPKM//'
    else:
        genomic_region='es2kb'
        par_dir='./'
        
    csv_file='{}/{}/{}_{}_differential_RPKM.csv'.format(par_dir,indir,antibody,genomic_region)
...
outdir='f2b_differential_UTX_RPKM_other_normByIslands_scatter'
