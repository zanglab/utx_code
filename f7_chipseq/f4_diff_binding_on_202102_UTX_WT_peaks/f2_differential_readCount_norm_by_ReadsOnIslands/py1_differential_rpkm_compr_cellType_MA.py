...
def return_chipseq_rpkm_csv(celltype,factor,genomic_region,norm_col):
    ...
    file_dir='{}/f7_chipseq/f4_diff_binding_on_202102_UTX_WT_peaks/data_RPKM/rpkm_csv'.format(project_dir)
    csv_file='{}/{}_{}_on_202102_UTX_WT_peaks_{}.csv'.format(file_dir,celltype,factor,genomic_region)
...
factors = ['UTXFEB','MLL4','H3K4me1','H3K4me2','H3K4me3','H3K27ac','H3K27me3']
