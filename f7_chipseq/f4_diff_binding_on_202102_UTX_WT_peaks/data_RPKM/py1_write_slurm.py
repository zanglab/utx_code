...
def return_chipseq_bam(project_dir,basename):
    ...
    sub_dirs=['re_1st_submission_H3K4me3_MLL4SC_trim','re_202012_H3K4me2_trim','202102_H3K27ac_H3K4me1_trim','202102_UTX_H3K27me3_trim']
...
factors= ['UTXFEB','H3K4me1','H3K4me2','H3K4me3','H3K27ac','H3K27me3','MLL4']
...
''')
        ...
        #########################
            ...
            slurmout.write('python get_RPM_RPKM_count_on_regions.py \\\n-i {} \\\n-t {} \\\n-s hg38 -f bam -m -e 500 -o {}/{}_on_202102_UTX_WT_peaks_es500bp.csv\n\n'.format(utx_peak,bamfile,outdir,basename))
            slurmout.write('python get_RPM_RPKM_count_on_regions.py \\\n-i {} \\\n-t {} \\\n-s hg38 -f bam -m -e 2000 -o {}/{}_on_202102_UTX_WT_peaks_es2kb.csv\n\n'.format(utx_peak,bamfile,outdir,basename))
