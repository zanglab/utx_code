...
outdir = 'f1_heatmap_RPO-seq_by_UTX_binding'
...
proseq_names_title ={'PCDH1PRO':'Vector rep1','PCDH2PRO':'Vector rep2',
                     'DEL31PRO':'DEL rep1','DEL32PRO':'DEL rep2',
                     'FL1PRO':'WT rep1','FL2PRO':'WT rep2'}
...
for proseq_name in proseq_names[:]:
    for norm_pattern in norm_patterns[:]:
        # == get the PROseq binding pattern
        # proseq_id_file = '{}/f6_proseq/data_0x2_MAPQ10/f4_pattern_at_PROseq_union_peak/{}_PROseq_peak_es2kb_bin200_{}.csv'.format(project_dir,proseq_name,norm_pattern)
        proseq_binding_file = '{}/f6_proseq/data_0x2_MAPQ10/f4_pattern_at_PROseq_union_peak/{}_PROseq_peak_es2kb_bin200_{}.csv'.format(project_dir,proseq_name,norm_pattern)
        proseq_binding_df = pd.read_csv(proseq_binding_file,sep='\t',index_col=0,header=None)
        # == do the normalization
        norm_factor=norm_df.loc[proseq_name,'total_dm6_f0x2']
