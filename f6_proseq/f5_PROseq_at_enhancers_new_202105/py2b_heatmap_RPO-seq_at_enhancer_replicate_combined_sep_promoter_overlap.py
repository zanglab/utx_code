...
outdir = 'f2b_heatmap_RPO-seq_at_enhancer_combi_rep_sep_promoter_overlap'
...
for promoter_overlap_type in promoter_overlap_types[:]:      
    ...
    for norm_pattern in norm_patterns[:1]:
        for prename in prenames[1:]:   
            composite_data = {}
            for proseq_name in proseq_names[:]:
                ...
                # plt.savefig(outdir+os.sep+'{}_heatmap_{}_binding_by_{}.png'.format(norm_pattern,proseq_names_title[proseq_name],prename),bbox_inches='tight',pad_inches=0.1,transparent=True,dpi=600)
                # plt.show()
                # plt.close()
            ...
            plt.savefig(outdir+os.sep+'composite_PROseq_binding_by_{}_at_{}_{}.png'.format(norm_pattern,prename,promoter_overlap_type),\
