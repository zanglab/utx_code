...
def plot_expression_cor_RPKM(df,stats_df,outdir,factor,count_type,compr_type,p_thre,fc_thre):
...
for factor in factors[:]:
    for count_type in count_types[:1]:
        for compr_type in compr_types[:]:
            plot_expression_cor_RPKM(combined_df,stats_df,outdir,factor,count_type,compr_type,p_thre,fc_thre)
