...
def plot_DCI_cor_RPKM(df,stats_df,outdir,factor,count_type,compr_type,batch,hm):
        ...
        for compr_type in compr_types[:]:
            for batch in ['Batch1','Batch2'][:]:
                for hm in ['H3K4me3','H3K27ac'][:]:
                    plot_DCI_cor_RPKM(combined_df,stats_df,outdir,factor,count_type,compr_type,batch,hm)
