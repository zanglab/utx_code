...
maps_dir='/nv/vol190/zanglab/zw5j/since2019_projects/UTX_HaoJiang/f0_data_process/hichip/data_202008/maps_results'

name_files = pd.read_excel('peak_file_names.xlsx',index_col=0,sheet_name='Rerun2') 
print(name_files)#;exit()
