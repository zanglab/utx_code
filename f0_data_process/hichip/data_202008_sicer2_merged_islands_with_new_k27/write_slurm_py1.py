...
hichip_dir='/nv/vol190/zanglab/zw5j/projects_data/UTX_HaoJiang/data_20200730/usftp21.novogene.com/raw_data/'
chipseq_dir='/nv/vol190/zanglab/zw5j/since2019_projects/UTX_HaoJiang/f0_data_process/chip_seq/final_chipseq/sicer2_islands/merged_islands/'
maps_dir='/nv/vol190/zanglab/zw5j/since2019_projects/UTX_HaoJiang/f0_data_process/hichip/data_202008_sicer2_merged_islands_with_new_k27/maps_results'

name_files = pd.read_excel('islands_file_names.xlsx',index_col=0) 
print(name_files)

for hichip_name in name_files.index:
    hichip_file1 = glob.glob('{}/{}/*1.fq.gz'.format(hichip_dir,hichip_name))[0]
    basename = os.path.basename(hichip_file1).split('_1.fq.gz')[0]
    peakname = name_files.loc[hichip_name,'chipseq_names']
    peakfile = '{}/{}.merged.bed'.format(chipseq_dir,peakname)
...
''')
        ...
        slurmout.write('fastq_format=".fq.gz"\n')
        slurmout.write('fastq_dir="{}/{}"\n'.format(hichip_dir,hichip_name))
