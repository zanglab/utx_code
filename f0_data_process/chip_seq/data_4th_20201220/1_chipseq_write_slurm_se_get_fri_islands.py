...
#             slurmout.write('module load samtools\n\n')
            ...
            slurmout.write('genome_index="{}"\n'.format(genome_index))
            slurmout.write('fqdir="{}"\n'.format(fqdir))
...
#             slurmout.write('python 2_chipseq_qc_se.py -i {} -o {} -s {} -b {} -f {}\n\n'.format(infile,qc_out_file,species,outname,split_flag)) 
            slurmout.write('python 2_chipseq_qc_se_append_add_fri_islands.py -i {} -o {} -s {} -b {} -f {}\n\n'.format(infile,qc_out_file,species,outname,split_flag))
