...
#             outf.write('\t{}'.format(total))
            ...
            outf.write('\t{}\t{}\t{:.3f}'.format(bam_total,rip,rip/bam_total)) 
            ...
            try:
                outf.write('\t{}\t{:.3f}'.format(peaks_overlapping_UDHS,peaks_overlapping_UDHS/peaks))   
            except:
                outf.write('\t{}\t{:.3f}'.format(peaks_overlapping_UDHS,0))   
