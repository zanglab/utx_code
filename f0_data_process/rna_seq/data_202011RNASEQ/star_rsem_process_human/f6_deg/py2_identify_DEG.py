...
def main(indir,outdir):
    ...
    for deseq2_file in deseq2_files:
        ...
        adjp,logfc = 0.05,np.log2(1.5)
        upgenes,dngenes = return_diff_genes_deseq2(deseq2_file,adjp,logfc)
        write_DEG(upgenes,outdir+os.sep+basename+'_adjp{}_logfc{:.2f}_upgenes.txt'.format(adjp,logfc))
        write_DEG(dngenes,outdir+os.sep+basename+'_adjp{}_logfc{:.2f}_dngenes.txt'.format(adjp,logfc))
