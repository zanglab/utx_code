...
''')
        ...
        #########################
            ...
            slurmout.write('#SBATCH -o {}/slurm_{}.out\n\n'.format(slurm_dir,basename))
            slurmout.write('python get_RPM_RPKM_count_on_regions.py -i {} -t {} -s hg38 -f bam -o rpkm_csv/{}_on_Macs2peak.csv\n'.format(peakfile,bamfile,basename))
            slurmout.write('python get_RPM_RPKM_count_on_regions.py -i {} -t {} -s hg38 -f bam -o rpkm_csv/{}_on_Sicer2peak.csv\n'.format(island_file,bamfile,basename))
            slurmout.write('python get_RPM_RPKM_count_on_regions.py -i {} -t {} -s hg38 -f bam -o rpkm_csv/{}_on_Promoter.csv\n'.format(promoter_file,bamfile,basename))
            slurmout.write('python get_RPM_RPKM_count_on_regions.py -i {} -t {} -s hg38 -f bam -m -e 10000 -o rpkm_csv/{}_on_Promoter_expand_10kb.csv\n'.format(promoter_file,bamfile,basename))
            slurmout.write('python get_RPM_RPKM_count_on_regions.py -i {} -t {} -s hg38 -f bam -o rpkm_csv/{}_on_GeneBody.csv\n'.format(gb_file,bamfile,basename))
