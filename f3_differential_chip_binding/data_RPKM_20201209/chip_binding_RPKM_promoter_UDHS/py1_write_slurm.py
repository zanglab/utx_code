...
bam_dir='{}/f0_data_process/chip_seq/data_202012/data_20201209CHIP/process_qc_out/'.format(project_dir)
...
celltypes = ['PCDH','WT','DEL3','EIF','MT2']
chip_markers= ['K27AC','K27M3','K4M2']
